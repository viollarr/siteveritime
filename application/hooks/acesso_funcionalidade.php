...
function acesso_funcionalidade() {
    ...
    $permissoes = array(
        1 => array(
            ...
            "cliente" => array("index", "lista", "busca", "cadastro", "editar", "cadastro", "insert", "editar", "update"),
            ...
            "atendimento" => array("index", "lista", "info_atendimento", "inf_download_xls", "inf_download_pdf", "cadastro", "editar", "cadastro", "insert", "editar", "update", "excluir", "get_by_id_app", "realizarCheck", "emailCriador", "notificacao", "atualizar_notificacao", "insertComentApp", "consultAppGrupos", "getEnderecoPrincipal", "getEnderecoFilial", "getIdNomeUsuario", "vericarExclusaoFuncionarioAtendimento", "vericarInclusaoFuncionarioAtendimento", "getIdNomeCliente", "getIdNomeResponsavel", "getValidacaoUser", "mapa_local", "busca","reagendar", "update_reagendar", "enviar_notificacao", "atualizarStatus"),
			"cidade" => array("getCidades"),
			"relatorio" => array("atendimentos", "download", "download2", "gerar", "relatorios"),
			"mapa" => array("visualizar", "visualizar2"),
			"autocomplete" => array("usuariosAutocomplete", "clientesAutocomplete", "contatosAutocomplete", "mapaAutocomplete"),
			"app" => array("atendimento"),
			"faq" => array("index","lista"),
			"contato" => array("index","formulario")
        ),
        2 => array(
            "dashboard" => array("index", "home", "interna", "mensagem"),
            "ajax_controller" => array("altera_status"),
        ...
        3 => array(
            "dashboard" => array("index", "home", "interna", "mensagem"),
			"usuario" => array("index"),
            "atendimento" => array("index", "lista", "busca", "info_atendimento", "inf_download_xls", "inf_download_pdf", "get_by_id_app", "realizarCheck", "getEnderecoPrincipal", "getEnderecoFilial", "getIdNomeUsuario", "insertComentApp", "emailCriador", "notificacao", "atualizar_notificacao", "consultAppGrupos", "atualizarStatus", "vericarExclusaoFuncionarioAtendimento", "vericarInclusaoFuncionarioAtendimento", "getIdNomeCliente", "getIdNomeResponsavel", "getValidacaoUser", "mapa_local", "busca"),
			"cidade" => array("getCidades"),
			"autocomplete" => array("usuariosAutocomplete", "clientesAutocomplete", "contatosAutocomplete", "mapaAutocomplete"),
			"app" => array("atendimento"),
			"faq" => array("index","lista"),

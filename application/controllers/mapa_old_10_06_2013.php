		...
		if(!empty($atendimentos)){
			...
			foreach($atendimentos as $atendimento){
				...
				*/
				...
				$checkin = (!empty($atendimento->ultimo_checkin)) ? fdata($atendimento->ultimo_checkin, "/") : "Nenhum checkin realizado";
				$checkout = (!empty($atendimento->ultimo_checkout)) ? fdata($atendimento->ultimo_checkout, "/") : "Nenhum checkout realizado";
				
				$array_tds = array();
				
				$contentString = '<table id="content" style="width:500px; border-collapse: inherit; border-spacing: 1px;">';
				
				$array_tds[] = '<td style="width: 168px; padding: 4px;"><strong>Nome do cliente</strong></td><td style="padding: 4px;">'.$atendimento->nomecliente.'</td>';			
				$array_tds[] = '<td style="width: 168px; padding: 4px;"><strong>Nome do atendimento</strong></td><td style="padding: 4px;">'.$atendimento->titulo.'</td>';
				$array_tds[] = '<td style="width: 168px; padding: 4px;"><strong>Status</strong></td><td style="padding: 4px;">'.$status.'</td>';
				$array_tds[] = '<td style="width: 168px; padding: 4px;"><strong>Data hora / Tempo estimado do atendimento</strong></td><td style="padding: 4px;">'.fdata($atendimento->data_agendada, "/").' '.substr($atendimento->hora_agendada, 0, 5).'h / '.substr($atendimento->tempo_estimado, 0, 5).'h</td>';
				$array_tds[] = '<td style="width: 168px; padding: 4px;"><strong>Endereço do atendimento</strong></td><td style="padding: 4px;">'.$endereco_completo.'</td>';

				if(!empty($atendimento->nome_contato_responsavel)){
					$array_tds[] = "<td style='width: 168px; padding: 4px;'><strong>Responsável</strong></td><td style='padding: 4px;'>".$atendimento->nome_contato_responsavel."</td>";
					...
					if(!empty($atendimento->telefone_contato_responsavel)){
						...
						$array_tds[] = "<td style='width: 168px; padding: 4px;'><strong>Telefone do Responsável</strong></td><td style='padding: 4px;'>".$atendimento->telefone_contato_responsavel."$ramal</td>";
						
					}
					if(!empty($atendimento->celular_contato_responsavel)){
						$array_tds[] = "<td style='width: 168px; padding: 4px;'><strong>Celular do Responsável</strong></td><td style='padding: 4px;'>".$atendimento->celular_contato_responsavel."</td>";
					}
				}else{
					$array_tds[] = "<td style='width: 168px; padding: 4px;'><strong>Contato Principal</strong></td><td style='padding: 4px;'>".$atendimento->nome_contato_principal."</td>";
					...
					if(!empty($atendimento->telefone_contato_principal)){
						...
						$array_tds[] = "<td style='width: 168px; padding: 4px;'><strong>Telefone do contato Principal</strong></td><td style='padding: 4px;'>".$atendimento->telefone_contato_principal."$ramal</td>";
						
					}
					if(!empty($atendimento->celular_contato_principal)){
						$array_tds[] = "<td style='width: 168px; padding: 4px;'><strong>Celular do contato Principal</strong></td><td style='padding: 4px;'>".$atendimento->celular_contato_principal."</td>";
					}
				}					
									
				$array_tds[] = '<td style="width: 168px; padding: 4px;"><strong>Checkin</strong></td><td style="padding: 4px;">'.$checkin.'</td>';
				$array_tds[] = '<td style="width: 168px; padding: 4px;"><strong>Checkout</strong></td><td style="padding: 4px;">'.$checkout.'</td>';

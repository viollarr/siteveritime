...
?>
		...
		$("#result_responsavel").append('<span class="'+classeCliente+'"><?php echo $contato->contato_responsavel; ?> <button alt="" class="'+classeCliente+' btn btn-danger btn-mini" style="cursor:pointer;" onclick="remuve(\''+classeCliente+'\',\'incluir_responsavel\');">Remover</button></span><br class="'+classeCliente+'" />');		
		$("#incluir_responsavel").val("Substituir");
<?php	
		}
	}

...
<ul>
       	  <li id="mostrar_tipo" style="display:none;">
                ...
                <img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="" data-toggle="tooltip" data-original-title="Adicione informações para ajudar sua equipe externa a chegar mais rápido ao local de atendimento. Útil para situações atípicas, sugerir melhores rotas ou alternativas de transporte público." width="16" height="16" /></li>            
            </ul>
      </fieldset>      
        ...
        <legend>Controle de status</legend>
            <ul>
                <li>
                    ...
                    <input type="radio" name="prioridade" value="nao" <?php echo set_radio('prioridade', 'nao', TRUE); ?>> Não&nbsp;&nbsp;<img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="" data-toggle="tooltip" data-original-title="Este atendimento é uma prioridade? Escolhendo “Sim”, ele será marcado com uma estrela na lista de atendimentos." width="16" height="16" /></li>
                <li>
                    <label>Status: </label>
                ...
                <img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="" data-toggle="tooltip" data-original-title="Novos atendimentos são marcados por padrão como “Em espera”, mas você pode escolher o status que quiser. Lembre-se que atendimentos atrasados aparecem no seu mapa, assim como os atendimentos de hoje." width="16" height="16" /></li> 
                <li>
                ...
                <img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="" data-toggle="tooltip" data-original-title="Opção para que o cliente confirme no local o check-out do funcionário, como uma assinatura de recibo. Marque “Sim” e serão exibidos os campos para cadastrar a assinatura e o e-mail para o qual ela será enviada." width="16" height="16" /></li>  

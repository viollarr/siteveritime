        ...
        <legend>Controle de Status</legend>
            <ul>
                ...
                <li>
                    ...
                    <input type="radio" name="tem_contra_senha" value="nao" <?php echo set_radio('tem_contra_senha', 'nao', ($atendimento->tem_contra_senha=='nao')); ?>> Não&nbsp;&nbsp;
                </li> 
                ...
                <li>
                    ...
                    <input type="radio" name="novo_atendimento" value="nao" <?php echo set_radio('novo_atendimento', 'nao'); ?>> Não&nbsp;&nbsp;
                    <p style="font-size:12px; margin-left:146px;">Obs: Ao marcar esta opção como "sim", o funcionário receberá uma notificação no celular ao iniciar o aplicativo.</p>
                </li> 
            </ul>
      </fieldset>  

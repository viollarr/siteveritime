...
?>		var classeUser = 'user_<?php echo $ids_funcionario ;?>';
		...
		$("#result_funcionarios").append('<span class="'+classeUser+'"><?php echo $nome_funcionario; ?> <img src="<?php echo base_url('assets/images/ico_cross.png'); ?>" alt="" class="'+classeUser+'"  style="cursor:pointer;" onclick="remuve(\''+classeUser+'\',1);"/></span><br class="'+classeUser+'" />');
<?php		
	}
}
?>
...
?>
		...
		$("#result_clientes").append('<span class="'+classeCliente+'"><?php echo $nome_cliente; ?> <img src="<?php echo base_url('assets/images/ico_cross.png'); ?>" alt="" class="'+classeCliente+'"  style="cursor:pointer;" onclick="remuve(\''+classeCliente+'\',2);"/></span><br class="'+classeCliente+'" />');
	...
	$.getJSON("<?php print base_url(); ?>atendimento/getIdNomeUsuario/"+$("#auto").val(),{}, function(j){
			...
			if(j != ''){
				...
				if(conteudo == 0){
						...
						$("#result_funcionarios").append('<span class="'+classeUser+'">'+j.nome+' <img src="<?php echo base_url('assets/images/ico_cross.png'); ?>" alt="" class="'+classeUser+'"  style="cursor:pointer;" onclick="remuve(\''+classeUser+'\',1);"/></span><br class="'+classeUser+'" />');
						$("#funcionarios").show();
						$("#auto").val("");
				}
				else{
					...
					if(encontrado >= 1){
						...
						$("#form").append('<input type="hidden" name="funcionarios_alocados[]" value="'+value_imput+'" class="'+classeUser+'" />');
						$("#result_funcionarios").append('<span class="'+classeUser+'">'+j.nome+' <img src="<?php echo base_url('assets/images/ico_cross.png'); ?>" alt="" class="'+j.idusuario+'"  style="cursor:pointer;" onclick="remuve(\''+classeUser+'\',1);"/></span><br class="'+classeUser+'" />');
						$("#funcionarios").show();
						$("#auto").val("");
					}
				}
	...
	$.getJSON("<?php print base_url(); ?>atendimento/getIdNomeCliente/"+$("#cli").val(),{}, function(j){
			...
			if(j != ''){
				...
				if(conteudo == 0){
						...
						$("#result_clientes").html('<span class="'+classeCliente+'">'+j.nome+' <img src="<?php echo base_url('assets/images/ico_cross.png'); ?>" alt="" class="'+classeCliente+'"  style="cursor:pointer;" onclick="remuve(\''+classeCliente+'\',2);"/></span><br class="'+classeCliente+'" />');
						$("#cliente").show();
      ...
      <fieldset>
        <legend>Informações Principais</legend>
            <ul>
                <li>
                    <label>Título: </label>
                    <input name="titulo" class="input-xlarge"  type="text" value="<?php echo set_value('titulo'); ?>" />
                </li>
                <!--<li>
                    <label>Tag: </label>
        ...
        <legend>Funcionários</legend>
            <ul>
                ...
                <li id="funcionarios" style="display:none;">
                	<div style="width:150px; float:left;">
                    	<label>Funcionários relacionados: </label>
                    </div>
                    <div style="width:auto; float:left;">
 	  ...
 	  <fieldset>
        <legend>Informações de Controle</legend>
            <ul>
                ...
                <li>
                    <label>Status: </label>
                    <span class="label label-warning"><input type="radio" name="status" value="nao_concluido" <?php echo set_radio('status', 'nao_concluido'); ?>> Não Concluído</span>&nbsp;&nbsp;
                    <span class="label label-success"><input type="radio" name="status" value="em_andamento" <?php echo set_radio('status', 'em_andamento'); ?>> Em Andamento</span>&nbsp;&nbsp;
                    <span class="label"><input type="radio" name="status" value="finalizado" <?php echo set_radio('status', 'finalizado'); ?>> Finalizado</span>&nbsp;&nbsp;
                    <span class="label label-info"><input type="radio" name="status" value="em_espera" <?php echo set_radio('status', 'em_espera', TRUE); ?>> Em Espera</span>&nbsp;&nbsp;
                    <span class="label label-important"><input type="radio" name="status" value="em_atraso" <?php echo set_radio('status', 'em_atraso'); ?>> Em Atraso</span>&nbsp;&nbsp;
                </li> 
                <li>

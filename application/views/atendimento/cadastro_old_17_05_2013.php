	...
	$.getJSON("<?php print base_url(); ?>atendimento/getIdNomeResponsavel/"+$("#auto1").val(),{}, function(j){
			if(j != ''){
				...
				if(conteudo == 0){
						...
						$("#result_responsavel").append('<span class="'+classeUser+'">'+j.nome+' <button alt="" class="'+classeUser+' btn btn-danger btn-mini"  style="cursor:pointer;" onclick="remuve(\''+classeUser+'\',3);">Remover</button></span><br class="'+classeUser+'" />');		
					...
					if(encontrado >= 1){
						...
						$("#result_responsavel").html('<span class="'+classeUser+'">'+j.nome+' <button alt="" class="'+j.idusuario+' btn btn-danger btn-mini"  style="cursor:pointer;" onclick="remuve(\''+classeUser+'\',3);">Remover</button></span><br class="'+classeUser+'" />');		
						$("#emails_assinatura").val(j.email);
						$("#responsavel").show();
						$("#auto1").val("");
						$("#incluir_responsavel").val("Substituir");
...
<div class="form-style">
    ...
    <input type="hidden" id="idcliente" value="" />
	  ...
	  <fieldset>
        <legend>Informações de Localização <img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="Estas informações são carregadas diretamente do cadastro do cliente. Você pode editá-las, mas atenção, elas valerão apenas para este atendimento. Qualquer alteração feita aqui não modificará o cadastro original de localização do cliente" width="16" height="16" /></legend>
        ...
        <legend>Controle de Status</legend>
            <ul>
                <li>
                    ...
                    <input type="radio" name="prioridade" value="nao" <?php echo set_radio('prioridade', 'nao', TRUE); ?>> Não&nbsp;&nbsp;<img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="Caso opte por 'Sim', o atendimento será assinalado com uma estrela." width="16" height="16" /></li>
                <li>
                    <label>Status: </label>
                ...
                <img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="Todo novo atendimento é marcado como 'Em Espera' de forma automática, mas você tem a liberdade de escolher o status que mais se adequar a este atendimento." width="16" height="16" /></li> 
                <li>

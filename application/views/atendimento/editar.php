...
// ADD Cliente
	...
	$("#buscar_cliente").on("focusin keyup", "#cli",function(e) {
		if((!empty($("#cliente_hora_click").val())) || $("#cliente_hora_click").val() != $(this).val()){
		...
		$("#cliente_hora_click").val($(this).val());
	});
...
?>
	...
	<?php
		$idestado_anterior = set_value("idestado", $atendimento->idestado);
		if(!empty($idestado_anterior)){
			$idcidade_anterior = set_value("idcidade", $atendimento->idcidade); 
			if(empty($idcidade_anterior)){
				$idcidade_anterior = 0;
			}
	?>
			//alert('<?php echo $idestado_anterior; ?>');
			$("#idestado").val('<?php echo $idestado_anterior; ?>');
			$("#idestado_text").val("<?php echo $idestado_anterior; ?>").trigger("change");
			$.post("",{}, function(j){
				//alert('<?php echo $idcidade_anterior; ?>');
				$("#idcidade").val('<?php echo $idcidade_anterior; ?>');
				$("#idcidade_text").val("<?php echo $idcidade_anterior; ?>");
			});
	<?php		
		}
	?>
	  ...
	  <fieldset>
        <legend>Informações principais</legend>
            <ul>
                <li>
                    <label>Título: </label>
                    <input name="titulo" id="titulo" class="input-xxlarge" type="text" value="<?php echo set_value('titulo', $atendimento->titulo); ?>" />
                ...
                <li id="buscar_cliente">
                    <label>Cliente: </label>
					<input type="hidden" id="cliente_hora_click" name="cliente_hora_click" value="" />
	...
	<fieldset>
		...
		<ul>
			...
			<li>
				...
				<input name="endereco_text" id="endereco_text" class="input-xlarge duplicado" type="text" value="<?php echo set_value('endereco', $atendimento->endereco); ?>" duplicar_valor="endereco" />
				<input type="hidden" id="endereco" name="endereco" value="<?php echo set_value('endereco'); ?>" />
			</li>
			<li>
				<label>Número: </label>
				<input name="endereco_numero_text" id="endereco_numero_text" type="text" class="numero input-mini duplicado" value="<?php echo set_value('endereco_numero', $atendimento->endereco_numero); ?>" duplicar_valor="endereco_numero" />
				<input type="hidden" id="endereco_numero" name="endereco_numero" value="<?php echo set_value('endereco_numero'); ?>" />
			</li>   
			<li>
				<label>Complemento: </label>
				<input name="endereco_complemento_text" id="endereco_complemento_text"  type="text" class="complemento input-small duplicado" value="<?php echo set_value('endereco_complemento', $atendimento->endereco_complemento); ?>" duplicar_valor="endereco_complemento" />
				<input type="hidden" id="endereco_complemento" name="endereco_complemento" value="<?php echo set_value('endereco_complemento'); ?>" />
			</li>                                   
			<li>
				<label>Bairro: </label>
				<input name="bairro_text" id="bairro_text" class="input-medium duplicado" type="text" value="<?php echo set_value('bairro', $atendimento->bairro); ?>" duplicar_valor="bairro" />
				<input type="hidden" id="bairro" name="bairro" value="<?php echo set_value('bairro'); ?>" />
			</li>  
			<li>
				<label>Estado: </label>
				<select name="idestado_text" id="idestado_text" valida="true" class='duplicado' duplicar_valor="idestado">
				...
				<input type="hidden" id="idestado" name="idestado" value="<?php echo set_value('idestado', $atendimento->idestado); ?>" />
			</li>
			<li>
				<label>Cidade: </label>
				<select name="idcidade_text" id="idcidade_text" class='duplicado' duplicar_valor="idcidade">
                    <option value="0" disabled="disabled">Escolha o estado primeiro</option>
				</select>        
				<input type="hidden" id="idcidade" name="idcidade" value="<?php echo set_value('idcidade', $atendimento->idcidade); ?>" />									
			</li>          
            <li>

...
<div class="form-style">
 ...
 <fieldset>
        ...
        <img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="" data-toggle="tooltip" data-original-title="Você pode editar estas informações, mas atenção, elas valerão apenas para este atendimento. Qualquer alteração feita aqui não modificará o cadastro original de localização do cliente." width="16" height="16" /></legend>
<ul>
	  ...
	  <fieldset>
        <legend>Controle de Status</legend>
            <ul>
                ...
                <img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="" data-toggle="tooltip" data-original-title="Caso opte por 'Sim', o atendimento será assinalado com uma estrela." width="16" height="16" /></li>
                <li>
                    <label>Status: </label>
                ...
                <img src="<?php echo base_url('/assets/images/ico_duvida.png'); ?>" class="tooltip-custom" title="" data-toggle="tooltip" data-original-title="Você tem a liberdade de escolher o status que mais se adequar a este atendimento." width="16" height="16" /></li> 
                <li>

			...
			<div id="contatos_principal">
				<ul class="info_contato_principal">
					<li>
						...
						<input name="responsavel" id="responsavel" type="text" class="responsavel input-large" value="<?php echo set_value('responsavel'); ?>" />
					</li>
					<li>
						...
						<input name="ramal" id="ramal" type="text" class="ramal input-mini" value="<?php echo set_value('ramal'); ?>" />
					</li>
					<li>

    ...
    <form action="<?php echo base_url('cliente/update'); ?>" method="post" id="form" class="well">
        ...
        <fieldset>
			...
			<div id="contatos_principal">
				<ul class="info_contato_principal">
					<li>
						<label for="responsavel">Responsável: </label>
						<input name="responsavel" id="responsavel" type="text" class="responsavel input-large" value="<?php echo set_value('responsavel', $contato_principal->contato_responsavel); ?>" />
					</li>
					<li>
						<label for="telefone">Telefone / Ramal: </label>
						<input name="telefone" id="telefone" type="text" class="telefone input-large" value="<?php echo set_value('telefone', $contato_principal->contato_telefone); ?>" /> / 
						<input name="ramal" id="ramal" type="text" class="ramal input-mini" value="<?php echo set_value('ramal', $contato_principal->contato_ramal); ?>" />
					</li>
					<li>
						<label for="celular">Celular: </label>
						<input name="celular" id="celular" type="text" class="celular input-large" value="<?php echo set_value('celular', $contato_principal->contato_celular); ?>" />
					</li>
					<li>
						<label for="email">E-mail: </label>
						<input name="email" id="email" class="input-xlarge" type="email" value="<?php echo set_value('email', $contato_principal->contato_email); ?>" />
					</li>     
				</ul>
			</div>
		</fieldset>
		<fieldset id="contatos_adicionais">
			...
			<div id="contatos">
                ...
                if (validation_errors())
                    $contatos = $this->cliente_model->form_contatos();
                ...
                ?>
						<ul class="info_contato">
							<li class="titulo_contato">	
								<?php			
								if (!empty($contato->idcliente_contato)) { echo "<input name='idscontatos[]' type='hidden' value='{$contato->idcliente_contato}'>"; $idscontatos[] = $contato->idcliente_contato; }
								?>
								<strong>Contato <span><?php echo $contador_contato; ?></span></strong>
								<button class='excluir_contato_cliente btn btn-mini btn-danger pull-right' type='button'><i class='icon-remove icon-white'></i> Remover contato</button>
							</li>
							<li>
								<label for="responsavel">Responsável: </label>
								<input name="contato_responsavel[]" id="responsavel" type="text" class="responsavel input-large" value="<?php echo $contato->contato_responsavel; ?>" />
							</li>
							<li>
								<label for="telefone">Telefone / Ramal: </label>
								<input name="contato_telefone[]" id="telefone" type="text" class="telefone input-large" value="<?php echo $contato->contato_telefone; ?>" /> / 
								<input name="contato_ramal[]" id="ramal" type="text" class="ramal input-mini" value="<?php echo $contato->contato_ramal; ?>" />
							</li>
							<li>
								<label for="celular">Celular: </label>
								<input name="contato_celular[]" id="celular" type="text" class="celular input-large" value="<?php echo $contato->contato_celular; ?>" />
							</li>
							<li>
								<label for="email">E-mail: </label>
								<input name="contato_email[]" id="email" class="input-xlarge" type="email" value="<?php echo $contato->contato_email; ?>" />
							</li>     
						</ul>
				  <?php
                    }//for
				...
				?>
					<ul class="info_contato">
						...
						<li>
							<label for="responsavel">Responsável: </label>
							<input name="contato_responsavel[]" id="responsavel" type="text" class="responsavel input-large" value="" />
						</li>
						<li>
							<label for="telefone">Telefone / Ramal: </label>
							<input name="contato_telefone[]" id="telefone" type="text" class="telefone input-large" value="" /> / 
							<input name="contato_ramal[]" id="ramal" type="text" class="ramal input-mini" value="" />
						</li>
						<li>
							<label for="celular">Celular: </label>
							<input name="contato_celular[]" id="celular" type="text" class="celular input-large" value="" />
						</li>
						<li>
							<label for="email">E-mail: </label>
							<input name="contato_email[]" id="email" class="input-xlarge" type="email" value="" />
						</li>     
					</ul>
				<?php } //if         ?>
			</div>
...
<script>
    jQuery(document).ready(function($){
        ...
        $("#contatos_adicionais").on('click', "#mais_contato_cliente", function(){
            // Gerar o índice do novo elemento.
            ...
            var $contato_template = "<ul class='info_contato' style='display:none;'><li class='titulo_contato'><strong>Contato <span>"+$novo_indice+"</span></strong>"+$botao_excluir+"</li><li><label for='responsavel'>Responsável: </label><input name='contato_responsavel[]' id='responsavel' type='text' class='responsavel input-large' /></li><li><label for='telefone'>Telefone / Ramal: </label><input name='contato_telefone[]' id='telefone' type='text' class='telefone input-large' /> / <input name='contato_ramal[]' id='ramal' type='text' class='ramal input-mini' /></li><li><label for='celular'>Celular: </label><input name='contato_celular[]' id='celular' type='text' class='celular input-large' /></li><li><label for='email'>E-mail: </label><input name='contato_email[]' id='email' class='input-xlarge' type='email' /></li></ul>";
			...
			$('#contatos').find('.info_contato:last').find("input[name='contato_telefone[]']").mask("(99) 9999-9999");
			$('#contatos').find('.info_contato:last').find("input[name='contato_celular[]']").mask("(99) 9999-9999?9").live('focusout', function(event) {
        ...
        $("#contatos").on('click', ".excluir_contato_cliente", function(event) {
            ...
            // Excluir a contato.
            var $contato = $(this).closest('.info_contato');
            $contato.animate({height: 'toggle'}, 700, function(){
                $contato.remove();
                var $i = 1;
                
                // Renumerar cada contato.
                $(".titulo_contato span").each(function(){
                    $(this).html($i);
                    $i++;
                });
            });

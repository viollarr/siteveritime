...
<div class="form-style">
    <form action="<?php echo base_url('usuario/update'); ?>" method="post" id="form" class="well" autocomplete="off">
     <input type="hidden" name="idusuario" value="<?php echo $usuario->idusuario; ?>" />
     <input type="hidden" name="login_atual" value="<?php echo $usuario->login; ?>" />
      ...
      <fieldset>
        <legend>Informações de Identificação</legend>
            <ul>
                ...
                <li>
                	<label>Código EMEI: </label>
                    Código do telefone ainda não foi registrado
                </li>
				<?php } ?>                                
                <li>
                    <label>E-mail: </label>
				...
				<li>
                    <label>Login: </label>
                    <input name="login" class="input-xlarge" type="text" value="<?php echo set_value('login', $usuario->login); ?>" />
                </li>
                <li>
                    <label>Perfil: </label>
                ...
                <li>
                    ...
                    <input name="senha" id="senha" class="senha input-medium" type="password" value="<?php echo set_value('senha', ''); ?>" /> [preencha caso queira alterar sua senha]
                </li>        
				<li>

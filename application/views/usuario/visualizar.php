...
<div class="form-style">
    ...
    <form id="form" class="well">
		...
		?>
			<fieldset>
			<legend>Informações dos Gerentes</legend>
				<?php
				...
				?>
					<ul>
						<li>
							<label><strong>Nome: </strong></label> 
							<?php echo $gestor->nome_usuario;?>
						</li>
						<li>
							<label><strong>E-mail: </strong></label> 
							<?php echo $gestor->email;?>
						</li>
						<li>
							<label><strong>Celular: </strong></label> 
							<?php echo $gestor->celular;?>
						</li>
						<li>
							<label><strong>Status: </strong></label> 
							 <?php
							  switch ($gestor->status_usuario) {
								  case "Ativo";
									  $alt_status = 'Ativo';
									  $estilo_status = 'success';
									  break;
		...
		else if(!empty($administradores)){
		?>
			<fieldset>
			<legend>Informações dos Administradores</legend>
				<?php
				...
				?>
					<ul>
						<li>
							<label><strong>Nome: </strong></label> 
							<?php echo $administrador->nome_usuario;?>
						</li>
						<li>
							<label><strong>E-mail: </strong></label> 
						...
						<li>
							<label><strong>Celular: </strong></label> 
							<?php echo $administrador->celular;?>
						</li>
						<li>
							<label><strong>Status: </strong></label> 
							 <?php
							  switch ($administrador->status_usuario) {
								  case "Ativo";
									  $alt_status = 'Ativo';
									  $estilo_status = 'success';
									  break;

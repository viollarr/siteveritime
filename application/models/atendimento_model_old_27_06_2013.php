...
class Atendimento_model extends CI_Model {
	...
	function get_atendimento($idatendimento = ""){	
		...
		if(!empty($idatendimento)){			
			$this->db->select("at.idatendimento, at.titulo as atendimento, at.prioridade, at.data_agendada, at.hora_agendada, at.tempo_estimado, at.endereco, at.endereco_numero, at.endereco_complemento, at.bairro, at.status, cli.nome AS nome_cliente, es.nome AS nomeestado, es.sigla AS uf, ci.nome AS nomecidade, GROUP_CONCAT(usu.nome ) as nome_usuario");

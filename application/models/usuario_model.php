...
################################################ APP ################################################################
    ...
    /**
     *
     * Atualiza a Latitude e Longitude do usuário cadastrado assim que o mesmo realizar o checkin ou clicar no botão Meu Local no aparelho.
     * @return boleano
     */
    function updateLatLong($idusuario, $latitude, $longitude) {	
	
		$this->latitude_usuario = $latitude;
		$this->longitude_usuario = $longitude;
...
#####################################################################################################################
    ...
    function get_by_id_nome($usuarioNome) {
        $usuarioNome = (string) addslashes($usuarioNome);
